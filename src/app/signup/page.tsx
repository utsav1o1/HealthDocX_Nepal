  ...
  return (
    <>
      ...
      <div className="min-h-[85vh] flex items-center justify-center relative overflow-hidden">
        <div className="floating-orb w-[500px] h-[500px] bg-teal-400 -top-60 -left-40" />
        <div className="floating-orb w-[400px] h-[400px] bg-brand-400 -bottom-40 -right-40" />
        ...
        >
          <div className="glass-card p-8 sm:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-surface-500 mt-2">Start organizing your health records today</p>
            </div>
            ...
            <p className="text-center text-sm text-surface-500 mt-6">
              ...
              <Link href="/signin" className="text-brand-500 hover:text-brand-600 font-semibold transition-colors">
                {t.nav.signin}
              </Link>
            </p>
          </div>
